...
%\begin{align}
%G =& 2 \left(\sum_{i=1}^2 \left\{ a_{i1}\log\frac{a_{i1}}{(\sum_j a_{ij})} + a_{i2}\log\frac{a_{i2}}{\sum_j a_{ij}}\right\} -\right. \\
%&\left.\sum_{i=1}^2 \left\{ a_{i1}\log\frac{\sum_{i}a_{i1}}{\sum_{i,j} a_{ij}} + a_{i2}\log\frac{\sum_{i}a_{i2}}{\sum_{i,j} a_{ij}}\right\}\right)
%\end{align}
